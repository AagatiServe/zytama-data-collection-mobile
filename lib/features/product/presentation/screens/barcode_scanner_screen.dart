...
class _BarcodeScannerScreenState extends State<BarcodeScannerScreen> {
  ...
  Future<void> _onDetect(BarcodeCapture capture) async {
    ...
    // Stop the scanner before navigating away so the camera hardware is
    // fully released before MultiCaptureScreen tries to open it.
                    ...
                    Positioned(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            AppStrings.alignBarcodeWithinFrame,
